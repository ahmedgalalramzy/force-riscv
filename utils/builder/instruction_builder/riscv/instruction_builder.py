...
def build_instructions():
    ...
    if output_all or main_only:
        ...
        process_instruction_file("input/rv32i_instructions_starter.xml", "output/rv32i_instructions.xml", "output/supported_rv32i_instructions.xml", adjust_instruction_by_format)
        process_instruction_file("input/rv64i_instructions_starter.xml", "output/rv64i_instructions.xml", "output/supported_rv64i_instructions.xml", adjust_instruction_by_format)
        process_instruction_file("input/f_instructions_starter.xml", "output/f_instructions.xml", "output/supported_f_instructions.xml", adjust_instruction_by_format)
        process_instruction_file("input/d_instructions_starter.xml", "output/d_instructions.xml", "output/supported_d_instructions.xml", adjust_instruction_by_format)
        process_instruction_file("input/q_instructions_starter.xml", "output/q_instructions.xml", "output/supported_q_instructions.xml", adjust_instruction_by_format)
    ...
    if output_all or c_ext_only:
        ...
        process_instruction_file("input/rv32c_instructions_starter.xml", "output/rv32c_instructions.xml", "output/supported_rv32c_instructions.xml", c_ext_adjust_instruction_by_format)
        process_instruction_file("input/rv64c_instructions_starter.xml", "output/rv64c_instructions.xml", "output/supported_rv64c_instructions.xml", c_ext_adjust_instruction_by_format)
